 ...
 * for example: if the APP_ENV is staging, the bundle id will be com.jetsetgo.staging
 */

const BUNDLE_ID = 'com.jetsetgo'; // ios bundle id
const PACKAGE = 'com.jetsetgo'; // android package name
const NAME = 'jetsetgoApp'; // app name
const EXPO_ACCOUNT_OWNER = 'jetsetgo'; // expo account owner
